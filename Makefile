...
CLASSIFY=single_variable_AUC.png single_variable_F1.png
...
$(CLASSIFY) xbg-powerset.txt: xbg-powerset.py data.py $(CLEANDATA)
	$(PYTHON) xbg-powerset.py

model_compare.txt: classifiers_compare.py $(CLEANDATA)
